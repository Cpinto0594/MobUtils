...
public class HttpManagerConverterFactory {
    ...
    public static <T> T DeserializeObject(Class<T> clazz, String values) {
        ...
        try {
            ...
            Logger.getLogger(HttpManager.class.getSimpleName()).warning(HttpManager.TAG + "Unable to convert data to desired class -> " + clazz.getSimpleName());
        }
        return (T) result;
    }
    ...
    public static <T> List<T> DeserializeArray(Class<T> clazz, String values) {
        ...
        try {
            ...
            Logger.getLogger(HttpManager.class.getSimpleName()).warning(HttpManager.TAG + "Unable to convert data to desired list of class -> " + clazz.getSimpleName());
        }
    ...
    public static String Serialize(Object values) {
        ...
        try {
            ...
            Logger.getLogger(HttpManager.class.getSimpleName()).warning(HttpManager.TAG + "Unable to convert data to String");
        }
